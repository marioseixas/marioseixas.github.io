...
<body>
  <main>
    <section>
      {% assign posts_with_sort_date = "" | split: "" %}
      {% for post in site.posts %}
        ...
        {% endif %}
        {% assign post_with_sort_date = post | jsonify | replace: '}', ', "sort_date": "' | append: sort_date | append: '"}' | parse_json %}
        {% assign posts_with_sort_date = posts_with_sort_date | push: post_with_sort_date %}
      {% endfor %}
